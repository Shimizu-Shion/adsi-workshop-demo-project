...
class AttendanceControllerTest {
    ...
    void clockIn_validRequest_returns201() throws Exception {
        ...
        when(attendanceService.clockIn(any(com.example.attendance.attendance.dto.ClockInRequest.class)))
                .thenReturn(response);
    ...
    void clockOut_validRequest_returns200() throws Exception {
        ...
        when(attendanceService.clockOut(any(com.example.attendance.attendance.dto.ClockOutRequest.class)))
                .thenReturn(response);
